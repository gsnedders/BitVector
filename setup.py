...
setup(name='BitVector',
      ...
      url='http://RVL4.ecn.purdue.edu/dist/BitVector-1.1.1.html',
      download_url='http://RVL4.ecn.purdue.edu/dist/?action=AttachFile&do=get&target=BitVector-1.1.1.tar.gz',
